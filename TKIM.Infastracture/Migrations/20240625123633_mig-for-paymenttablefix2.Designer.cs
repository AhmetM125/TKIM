...
namespace TKIM.Infastracture.Migrations
{
    ...
    [Migration("20240625123633_mig-for-paymenttablefix2")]
    partial class migforpaymenttablefix2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TKIM.Entity.Entity.PaymentItems", b =>
                {
                    ...
                    b.Property<Guid>("SALE_RECORD_ID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TKIM.Entity.Entity.PurchaseRecord", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("PROFIT_EDITED")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PURCHASE_PRICE")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PURCHASE_PRICE_BEFORE")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<short>("QUANTITY_CURRENT")
                        .HasColumnType("smallint");

                    b.Property<short>("QUANTITY_PURCHASED")
                        .HasColumnType("smallint");

                    b.Property<decimal>("SALE_PRICE")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SALE_PRICE_EDITED")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TAX")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TAX_BEFORE")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TAX_EDITED")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TOTAL")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TOTAL_EDITED")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TKIM.Entity.Entity.SaleRecord", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<short>("QUANTITY_SOLD")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("TKIM.Entity.Entity.Invoice", b =>
                {
                    ...
                    b.HasOne("TKIM.Entity.Entity.Payment", "Payment")
                        .WithOne("Invoice")
                        .HasForeignKey("TKIM.Entity.Entity.Invoice", "PAYMENT_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TKIM.Entity.Entity.PaymentItems", b =>
                {
                    ...
                    b.HasOne("TKIM.Entity.Entity.SaleRecord", "SaleRecord")
                        .WithOne("PaymentItems")
                        .HasForeignKey("TKIM.Entity.Entity.PaymentItems", "SALE_RECORD_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
